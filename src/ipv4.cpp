...
auto parse_string_to_octets(const std::string& addr_string) -> std::array<uint8_t, 4>
{
...
ipv4::ipv4(const std::string& addr_string) : addr_{detail::parse_string_to_octets(addr_string)} {}

[[nodiscard]] auto ipv4::to_string() const -> std::string
{
    return fmt::format("{}.{}.{}.{}", addr_[0], addr_[1], addr_[2], addr_[3]);
}
